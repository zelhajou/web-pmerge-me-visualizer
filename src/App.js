...
import { ChevronLeft, ChevronRight, SkipBack, SkipForward, Play, Pause, RefreshCw, Code, GitBranch, CodeSquare } from 'lucide-react';
...
const App = () => {
  ...
  const navItems = [
    ...
    { id: 'insertionOrder', label: 'Insertion Order', icon: <GitBranch size={16} /> }
  ];
    ...
    <div className="h-screen overflow-hidden flex flex-col bg-gray-50">
      ...
      <main className="flex-1 overflow-hidden container mx-auto px-4 py-4 flex flex-col">
        ...
        <div className="mb-4 bg-white border rounded-lg overflow-hidden shadow-sm">
          <div className="border-b p-3 bg-gradient-to-r from-blue-50 to-blue-100">
      ...
      <footer className="bg-gray-800 text-white py-3 text-center">
        <p className="text-sm">PmergeMe Visualizer — Ford-Johnson Algorithm Implementation</p>
        <p className="text-xs text-gray-400 mt-1">Designed for understanding merge-insert sort (Exercise 02)</p>
      </footer>
    </div>
  );
};
